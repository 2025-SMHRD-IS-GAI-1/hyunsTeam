...
public class NaverCallbackServcie implements Service {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        uvo.setUser_id(id);
        uvo.setName(name);
        uvo.setSocial_type("naver");
        UserVO loginUser = dao.socialLogin(id);
        if(loginUser != null) {
